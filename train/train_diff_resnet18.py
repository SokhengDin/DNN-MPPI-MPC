...
def train_resnet18(states, controls, errors, num_epochs, batch_size, learning_rate):
    ...
    plot_path = "training_metrics_resnet18_300x100_mppi.png"
    plot_training_metrics(train_losses, val_losses, train_maes, val_maes, plot_path)

    # Save the model
    save_dir = "saved_models"
    os.makedirs(save_dir, exist_ok=True)
    model_save_path = os.path.join(save_dir, "resnet18_diff_300x100_mppi.pth")
...
trained_model, avg_train_loss, avg_val_loss, avg_train_mae, avg_val_mae = train_resnet18(states, controls, errors, num_epochs, batch_size, learning_rate)
